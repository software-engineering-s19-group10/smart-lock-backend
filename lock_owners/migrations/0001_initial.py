# Generated by Django 2.1.7 on 2019-03-31 22:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visitor', models.ForeignKey(help_text='User that permissions are for', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='StrangerReport',
            fields=[
                ...
                ('stranger_report_time', models.DateTimeField(default=datetime.datetime.now, help_text='Date and time the report was made')),
